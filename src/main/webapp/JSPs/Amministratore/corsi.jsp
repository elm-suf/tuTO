...
<div id="wrapper">
    ...
    <div class="wrapper">
        ...
        <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent" ng-controller="main">
                        <ul class="nav navbar-nav ml-auto text-center">
                            <li class="nav-item">
                                <a class="nav-link" onclick="" href="/JSPs/profilo.jsp">Profilo <i class="fa fa-user"></i></a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="container" style="overflow: auto" ng-controller="corsi_ctrl" ng-cloak>
